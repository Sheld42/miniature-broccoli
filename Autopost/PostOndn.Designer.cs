namespace Autopost
{
    partial class PostOndn
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PostOndn));
            ...
            this.label1.Text = "Отсутствует сертификат лицензии!";
            ...
            this.label2.Text = "Обратитесь к разработчику программы для получения сертификата,";
            // 
            // label3
            // 
            ...
            this.label3.Text = "сообщив Ваш серийный ключ:";
            // 
            // textBox1
            // 
